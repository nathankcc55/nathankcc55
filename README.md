...
- Managed a large-scale integration of eight distinct data sources (~1.5GB of data, >1M observations) using GCP (Google Cloud Platform) for storage and processing.
